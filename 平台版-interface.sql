...
-- 资金账户管理
(replace(uuid(), '-', ''), '获取账户详情', 'GET', '/account/v1.0/accounts', 'getAccount', 1, NULL, NULL, NULL, 1, 1, now()),
...
(replace(uuid(), '-', ''), '导出账户对账单', 'GET', '/account/v1.0/accounts/checks', 'getCheck', 1, NULL, NULL, NULL, 1, 1, now()),
...
-- 在线结算
(replace(uuid(), '-', ''), '支付宝回调', 'POST', '/account/callback/alipay', NULL, 0, NULL, NULL, NULL, 0, 0, now()),
(replace(uuid(), '-', ''), '微信回调', 'POST', '/account/callback/wechat', NULL, 0, NULL, NULL, NULL, 0, 0, now()),
